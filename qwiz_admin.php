...
function qwiz_admin_init () {
   ...
   // ........................................................................
   // Opt-out/in to info reporting.
   add_settings_section ('qwiz-info_report-section', 
                         'Report usage statistics to Qwizcards.com - opt-out/in',
                         'qwiz_info_report_text', 'qwiz-options-page');

   add_settings_field ('qwiz-info_report-field', 'Disallow usage statistics',
                       'qwiz_info_report_field_input', 'qwiz-options-page', 
                       'qwiz-info_report-section');
...
function qwiz_options_validate ($options) {
   ...
   // ............................................
   // Disallow info reporting if checkbox set.
   if (isset ($options['disallow_info_report'])) {
      $options['info_sent_time'] = -1;
   } else {
...
// -----------------------------------------------------------------------------
function qwiz_info_report_text () {
   print '<p style="margin-bottom: 0px;">';
   print 'Quiz and flashcard deck use is counted and -- not more frequently ';
   print 'than once a week -- sent to Qwizcards.com.  This will help us to ';
   print 'understand what features are most used and where to focus our ';
   print 'development efforts. You may opt out of this reporting.';
   print '</p>';
}


function qwiz_info_report_field_input () {
   global $options;

   // Checkbox to opt out ("disallow").
   if (isset ($options['info_sent_time'])) {
      $info_sent_time = $options['info_sent_time'];
   } else {
      $info_sent_time = 0;
   }
   $checked = $info_sent_time == -1 ? 'checked' : '';
   print '<input id="qwiz_load_jquery" name="qwiz_options[disallow_info_report]" '
...
function qwiz_load_jquery_text () {
   ...
   print 'default), you can ensure that it is loaded.';
   print '</p>';
}
...
function qwiz_load_jquery_field_input () {
   ...
   print '<input id="qwiz_report_info" name="qwiz_options[force_jquery_load]" '
      .      'type="checkbox" ' . $checked . ' /> ';
